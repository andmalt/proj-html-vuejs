<template>
    <header class="container-fluid" id="bg">
        <!-- logo and icons -->
        <div class="row">
            <div class="col-6 text-center py-4 logo_h">
                <a href="#home"><img src="../assets/img/avadabarbers-logo-x1.png" alt="logo Avada Barbers"></a>
            </div>
